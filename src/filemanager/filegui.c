...
gboolean preserve_ext2_attr = TRUE;
#else
gboolean preserve_ext2_attr = FALSE;
#endif
                  ...
                  const char *def_text, gboolean *do_bg)
{
    ...
    *do_bg = FALSE;
    ...
    {
        gboolean preserve_ext2 = preserve_ext2_attr;
...
#ifdef ENABLE_EXT2FS_ATTR
                QUICK_CHECKBOX (N_ ("Preserve e&xt2 attributes"), &preserve_ext2, NULL),
#endif
            QUICK_NEXT_COLUMN,
        ...
        preserve_ext2_attr = preserve_ext2;
